              ...
              >
                <div className="flex items-center">
                  <p className="w-full leading-6">
                    We noticed that you&apos;re signing in from India. Do you
                    want your current location to be updated as we personalize
                    the companies and opportunities for you according to your
                    location?
                  </p>
                </div>
